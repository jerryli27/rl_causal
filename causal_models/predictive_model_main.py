...
if __name__ == '__main__':
  ...
  intervened_state = intervention_model.ge_intervention_model(current_state, action, num_possible_actions)
  predicted_next_state = predictive_model.get_predictive_model(intervened_state, model_type)
