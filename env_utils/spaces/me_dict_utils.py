"""Implements a mutually exclusive dict that is a subclass of gym spaces."""
...
class MutuallyExclusiveDict(gym.spaces.Space):
  """
  ...
  def __init__(self, spaces=None, **spaces_kwargs):
    ...
    for space in spaces.values():
      assert isinstance(space, gym.spaces.Space), 'Values of the dict should be instances of gym.Space'
    self.space_keys = [k for k in self.spaces.keys()]
    # None for shape and dtype, since it'll require special handling
    super(MutuallyExclusiveDict, self).__init__(None, None)
